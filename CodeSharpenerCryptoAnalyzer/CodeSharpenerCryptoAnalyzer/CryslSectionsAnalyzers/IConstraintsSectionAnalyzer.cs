...
namespace CodeSharpenerCryptoAnalysis.CryslSectionsAnalyzers
{
    ...
    {
        List<ConstraintsModel> AnalyzeParameters(IEnumerable<ArgumentListSyntax> actualParameters, ICollection<ArgumentTypes> cryslParameters, ICollection<Constraints> constraintsList);
